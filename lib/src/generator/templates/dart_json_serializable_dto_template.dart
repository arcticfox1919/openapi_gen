...
String _generateUndiscriminatedUnionTemplate(
    UniversalComponentClass dataClass, String className, bool useMultipartFile, bool includeIfNull,
    [String? fallbackUnion]) {
...
sealed class $className {
  ...
  final helperExtension = _generateUndiscriminatedExtension(className, variants, fallbackUnion);
...
String _generateUndiscriminatedExtension(String className, Map<String, Set<UniversalType>> variants,
    [String? fallbackUnion]) {
...
String _generateDiscriminatedWrapperClasses(String className, Discriminator discriminator,
    bool useMultipartFile, bool includeIfNull, String? fallbackUnion) {
...
String _parametersInClass(
  ...
  List<FieldParser> fieldParsers,
    ...
    parameters.mapIndexed((i, e) {
      final dartType = _renameUnionTypes(
          e.toSuitableType(ProgrammingLanguage.dart, useMultipartFile: useMultipartFile));
      final fieldParser = fieldParsers.firstWhereOrNull((f) => f.applyToType == dartType);
