...
import '../models/api_v1_tagged_as_exclude_but_included_should_be_included_request_body.dart';
...
class ClientClient {
  ...
  Future<GetApiV1TaggedAsExcludeButIncludedShouldBeIncludedResponse>
      apiV1CategoryList({
    required ApiV1TaggedAsExcludeButIncludedShouldBeIncludedRequestBody body,
  }) async {
    final response = await _gio.get(
      '${_baseUrl ?? ''}/api/v1/tagged-as-exclude-but-included-should-be-included/',
      jsonBody: body.toJson(),
    );
    return GetApiV1TaggedAsExcludeButIncludedShouldBeIncludedResponse.fromJson(
