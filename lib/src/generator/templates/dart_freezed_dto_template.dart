...
${descriptionComment(dataClass.description)}@Freezed(${[
    ...
    if (discriminator != null && fallbackUnion != null && fallbackUnion.isNotEmpty)
...
String _factories(UniversalComponentClass dataClass, String className, bool useMultipartFile,
    bool includeIfNull, String? fallbackUnion,
  ...
  for (final discriminatorValue in dataClass.discriminator!.discriminatorValueToRefMapping.keys) {
    ...
    final discriminatorRef =
        dataClass.discriminator!.discriminatorValueToRefMapping[discriminatorValue]!;
...
String _createFactoriesForUndiscriminatedUnion(String className,
    Map<String, Set<UniversalType>> variants, bool useMultipartFile, bool includeIfNull) {
  final factories = <String>[];
  for (final MapEntry(key: variantName, value: factoryParameters) in variants.entries) {
...
String _jsonFactories(
    String className, Map<String, Set<UniversalType>>? undiscriminatedUnionVariants) {
