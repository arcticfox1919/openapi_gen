...
class ClientClient {
  ...
  Future<GetApiV1NotTaggedShouldBeIncludedResponse> apiV1CategoryList({
    required ApiV1NotTaggedShouldBeIncludedRequestBody body,
  }) async {
    final response = await _gio.get(
      '${_baseUrl ?? ''}/api/v1/not-tagged-should-be-included/',
      jsonBody: body.toJson(),
    );
    return GetApiV1NotTaggedShouldBeIncludedResponse.fromJson(
