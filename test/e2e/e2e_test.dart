        ...
        (outputDirectory, schemaPath) => SWPConfig(
          ...
          fieldParsers: [
            const FieldParser(
              ...
              parserAbsolutePath: 'package:your_package/lib/utils/parsers/custom_int_parser.dart',
            ),
            const FieldParser(
              applyToType: 'int?',
            ...
            const FieldParser(
              ...
              parserAbsolutePath: 'package:your_package/lib/utils/parsers/custom_bool_parser.dart',
            ),
          ],
        ),
        schemaFileName: 'openapi.yaml',
