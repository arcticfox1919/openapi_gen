...
class FamilyClient {
  ...
  /// Get family members (returns anyOf directly)
  Future<List<GetFamilyMembersResponseUnion>> getFamilyMembers() async {
    final response = await _gio.get(
      '${_baseUrl ?? ''}/family/members',
    );
    return (jsonDecode(response.body) as List)
        .map((e) =>
            GetFamilyMembersResponseUnion.fromJson(e as Map<String, dynamic>))
        .toList();
  }
}
