...
import 'package:openapi_gen/src/utils/file/io_file.dart';
...
class ConfigProcessor {
  ...
  YamlMap readConfigFromFile(List<String> arguments, ArgResults? argResults) {
    ...
    final yamlMap = yamlFile['openapi_gen'] as YamlMap?;

    if (yamlMap == null) {
      throw ConfigException(
        "`${configFile.path}` file does not contain a 'openapi_gen' section.",
      );
    }
